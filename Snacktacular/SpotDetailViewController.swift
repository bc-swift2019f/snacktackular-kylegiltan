...
class SpotDetailViewController: UIViewController {
    ...
    var reviews: Reviews!
    var photos: Photos!
    let regionDistance: CLLocationDistance = 750 //750 meters/half mile
    ...
    override func viewDidLoad() {
        ...
        if spot == nil{//add new record, field should be editable
            spot = Spot()
            getLocation()
...
//        addressField.text = spot.address
    ...
    @IBAction func textFieldReturnedPressed(_ sender: UITextField) {
    ...
    @IBAction func textFieldEditingChangd(_ sender: UITextField) {
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == ""{
            saveCancelAlert(title: "This Venue Has Not Been Saved", message: "You must save this venue before you can add a phtoto.", segueIdentifier: "AddPhoto")
        }
        else{
...
//                place = (placemark?.name)!
                name = placemark?.name ?? "name uknown"
